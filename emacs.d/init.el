...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (terraform-mode alchemist elixir-mode haml-mode dumb-jump typescript-mode elm-mode solarized-theme markdown-mode json-mode clojure-mode yaml-mode nyan-mode ensime))))
(tool-bar-mode -1)
(blink-cursor-mode 0)
